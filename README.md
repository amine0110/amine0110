...
| --- | --- | --- | --- | --- | --- |
| Medical Annotation for Yolo | This repository contains code for our tool that converts medical annotations into YOLO-v5-v8 format. The tool is designed for easy use and has a simple interface, which makes the process of annotation conversion as easy as a single command. | `Free` | [GitHub](https://github.com/amine0110/yolo-sam) | [Yes](https://github.com/amine0110/medical-tools/blob/main/Medical_Annotation_For_Yolo.md) | Not available |
...
| Desktop Dicom Visualizer | This application if to visualize the dicoms, change their contrast, anonymize them, convert them to JPG, NIFTI, MP4 | `Free` | [GitHub](https://github.com/pycadd/YouTube-Tutorials/tree/main/2024-04-22-dicoms-simplified) | [Yes](https://github.com/amine0110/medical-tools/blob/main/Dicoms_Simplified.md) | Not available |
| Online Dicom Visualizer | This is a web based dicom visualizer where you have access to the 3 views (Axial, Saggital, Coronal) and you can scroll between the slices | `Free` | [GitHub](https://github.com/pycadd/YouTube-Tutorials/tree/main/2024-03-26-online_dicom_nifti_viewer) | Not available | Not available |
